...
namespace Wawans\LaravelSupport\Request;
...
/**
 * Converting from Base64 to Uploaded File
 *
 * @see https://github.com/protonemedia/laravel-mixins
 */
trait ConvertsBase64ToFiles
{
    ...
    protected function prepareForValidation()
    {
        ...
        Collection::make($flattened)->each(function ($filename, $key) {
                ...
                // eg : data:application/pdf;base64, XXX
